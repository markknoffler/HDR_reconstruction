...
class Options:
    """
    Options and settings for training, debugging and evaluation of ArtHDRNet model.
    """
    ...
    def __init__(self):
        ...
        self.parser.add_argument(
            ...
            type=int,
            default="4",
            help="number of iterations for feedback mechanisms in ArtHDRNet",
        )
        ...
        self.parser.add_argument(
            "--save_val_samples",
            action="store_true",
            help="save validation samples during training",
        )
